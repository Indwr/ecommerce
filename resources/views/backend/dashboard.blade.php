    ...
    <div class="col-lg-12">
        <div class="row gutters-10">
            <div class="col-6 col-lg-3">
                <div class="grad bg-grad-2 text-white rounded-lg mb-4 overflow-hidden">
                    <div class="px-3 pt-3">
            ...
            <div class="col-6 col-lg-3">
                <div class="grad bg-grad-3 text-white rounded-lg mb-4 overflow-hidden">
                    <div class="px-3 pt-3">
                        <div class="opacity-50">
                            <span class="fs-12 d-block">{{ translate('Total') }}</span>
                            {{ translate('Order') }}
            ...
            <div class="col-6 col-lg-3">
                <div class="grad bg-grad-1 text-white rounded-lg mb-4 overflow-hidden">
                    <div class="px-3 pt-3">
                        <div class="opacity-50">
                            <span class="fs-12 d-block">{{ translate('Total') }}</span>
            ...
            <div class="col-6 col-lg-3">
                <div class="grad bg-grad-4 text-white rounded-lg mb-4 overflow-hidden">
                    <div class="px-3 pt-3">
                        <div class="opacity-50">
                            <span class="fs-12 d-block">{{ translate('Total') }}</span>
...
<div class="card">
    ...
    <div class="card-body">
        <div class="aiz-carousel gutters-10 half-outside-arrow" data-items="6" data-xl-items="5" data-lg-items="4" data-md-items="3" data-sm-items="1" data-arrows='true'>
                    ...
                    <div class="aiz-card-box border border-light rounded shadow-sm hov-shadow-md mb-2 has-transition bg-white">
                        ...
                        <div class="p-md-3 p-2 text-left">
                            <div class="fs-15">
                                ...
                                @endif
                                <span class="fw-700 text-main">{{ home_discounted_base_price($product->id) }}</span>
                            </div>
