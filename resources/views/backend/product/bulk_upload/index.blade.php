...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="alert" style="color: #000000;
    background-color: rgb(248 134 31 / 32%);
    border-color: #f8861f;
    margin-bottom: 0;
    margin-top: 10px;">
            ...
            <br>
            <div class="">
                <a href="{{ static_asset('download/product_bulk_demo.xlsx') }}" download><button class="btn btn-main">{{ translate('Download CSV')}}</button></a>
            </div>
            <div class="alert" style="color: #000000;
    background-color: rgb(248 134 31 / 32%);
    border-color: #f8861f;
    ...
    margin-top: 10px;">
            ...
            <br>
            <div class="">
                <a href="{{ route('pdf.download_category') }}"><button class="btn btn-main">{{translate('Download Category')}}</button></a>
                <a href="{{ route('pdf.download_brand') }}"><button class="btn btn-main">{{translate('Download Brand')}}</button></a>
            </div>
            <br>
        </div>
    </div>
        ...
        <div class="card-body">
            <form class="form-horizontal" action="{{ route('bulk_product_upload') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group mb-0">
                    <button type="submit" class="btn btn-main">{{translate('Upload CSV')}}</button>
                </div>
            </form>
        </div>
    </div>
