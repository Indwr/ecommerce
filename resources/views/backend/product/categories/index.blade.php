    ...
    <div class="card-body">
        <table class="table aiz-table mb-0">
			...
			<td>{{ $category->level }}</td>
                        ...
                        <td class="text-right inline__flex" style="    display: inline-table;">
                            <a class="btn btn-soft-primary btn-icon btn-circle btn-sm edit__" href="{{route('categories.edit', ['id'=>$category->id, 'lang'=>env('DEFAULT_LANGUAGE')] )}}" title="{{ translate('Edit') }}">
                                <i class="las la-edit"></i>
                            </a>
                            <a href="#" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete edit__" data-href="{{route('categories.destroy', $category->id)}}" title="{{ translate('Delete') }}">
