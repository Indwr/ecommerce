    ...
    <div class="d-xl-none d-flex">
        ...
        <div class="aiz-topbar-logo-wrap d-flex align-items-center justify-content-start">
            ...
            <a href="{{ route('admin.dashboard') }}" class="d-block">
                ...
                @else
                    <img src="{{ static_asset('assets/img/logo-mini.png') }}" class="brand-icon" alt="{{ get_setting('website_name') }}">
                @endif
            </a>
        </div>
    </div>
            ...
            <div class="d-none d-md-flex justify-content-around align-items-center align-items-stretch">
                <div class="aiz-topbar-item">
                    <div class="d-flex align-items-center">
                        <a class="btn btn-icon btn-circle demo__" href="{{ route('home')}}" target="_blank" title="{{ translate('Browse Website') }}">
            ...
            <div class="aiz-topbar-item ml-2">
                <div class="align-items-stretch d-flex dropdown">
                    <a class="dropdown-toggle no-arrow" data-toggle="dropdown" href="javascript:void(0);" role="button" aria-haspopup="false" aria-expanded="false">
                        <span class="btn btn-icon p-1 notify__">
