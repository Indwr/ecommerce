...
<div class="row gutters-10">
    <div class="col-md-4">
        <div class="bg-grad-1 grad text-white rounded-lg mb-4 overflow-hidden" style="min-height: 100px;">
            <div class="px-3 pt-3">
                @php
    ...
    <div class="col-md-4">
        <div class="bg-grad-2 grad text-white rounded-lg mb-4 overflow-hidden" style="min-height: 100px;">
            <div class="px-3 pt-3">
                @php
    ...
    <div class="col-md-4">
        <div class="bg-grad-3 grad text-white rounded-lg mb-4 overflow-hidden" style="min-height: 100px;">
            <div class="px-3 pt-3">
                @php
                    $orders = \App\Order::where('user_id', Auth::user()->id)->get();
                    $total = 0;
