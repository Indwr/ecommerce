...
-->
                ...
                <div class="@if($num_todays_deal > 0) col-lg-12  no-padding @else col-lg-12 @endif">
                    ...
                    @endif
                    @if (count($featured_categories) > 0)
                        <ul class="list-unstyled mb-0 row gutters-5" style="display:none">
                ...
                <div class="col-lg-2 order-3 mt-3 mt-lg-0"  style="display:none">
