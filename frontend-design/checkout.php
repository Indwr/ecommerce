<?php include "header.php"; ?>
    ...
    <div class="container">
                <div class="customer-zone mb-20">
                    ...
                    <div class="checkout-login-info open-toggle-1" style="display: none;">
                ...
                <div class="customer-zone mb-20">
                    ...
                    <div class="checkout-login-info3" style="display: none;">
                        <form action="#">
                    ...
                    <div class="row">
                        <div class="col-lg-7">
                            <div class="billing-info-wrap mr-50">
                                ...
                                <div class="different-address open-toggle mt-30" style="display: none;">
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6">
                                            <div class="billing-info mb-20">
                                ...
                                <div class="your-order-wrap gray-bg-4">
                                    ...
                                    <div class="payment-method">
                                        ...
                                        <div class="pay-top sin-payment sin-payment-3">
                                            ...
                                            <label for="payment-method-4">PayPal <img alt="" src="images/payment.png"><a href="#">What is PayPal?</a></label>
                                            <div class="payment-box payment_method_bacs">
                                                <p>Make your payment directly into our bank account. Please use your Order ID as the payment reference.</p>
                                            </div>
                                        </div>
